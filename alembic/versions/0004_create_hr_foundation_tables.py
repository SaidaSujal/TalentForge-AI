...
work_mode_enum = postgresql.ENUM(
    "REMOTE", "HYBRID", "OFFICE", name="work_mode_enum", create_type=False
)
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_job_descriptions_company_created_at",
        "job_descriptions",
        ["company_id", "created_at"],
        unique=False,
    )
    op.create_index(
        "ix_job_descriptions_company_department",
        "job_descriptions",
    ...
    op.create_index(
        "ix_job_descriptions_company_jd_hash",
        "job_descriptions",
        ["company_id", "jd_hash"],
        unique=False,
    )
    op.create_index(
        "ix_job_descriptions_company_title",
        "job_descriptions",
        ["company_id", "title"],
        unique=False,
    )
    op.create_index(
        op.f("ix_job_descriptions_department"),
        "job_descriptions",
        ["department"],
        unique=False,
    )
    op.create_index(
        op.f("ix_job_descriptions_jd_hash"),
        "job_descriptions",
        ["jd_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_job_descriptions_title"), "job_descriptions", ["title"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "phone", sa.String(length=50), nullable=True, comment="Contact phone number"
        ),
        sa.Column(
            "department",
            sa.String(length=100),
    ...
    op.create_index(
        "ix_employees_company_created_at",
        "employees",
        ["company_id", "created_at"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_employees_company_role", "employees", ["company_id", "role"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "ix_resumes_company_candidate",
        "resumes",
        ["company_id", "candidate_id"],
        unique=True,
    )
    op.create_index(
        "ix_resumes_company_hash",
        "resumes",
        ["company_id", "resume_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_resumes_company_id"), "resumes", ["company_id"], unique=False
    )
    op.create_index(
        op.f("ix_resumes_resume_hash"), "resumes", ["resume_hash"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_job_descriptions_company_department", table_name="job_descriptions"
    )
    op.drop_index(
        "ix_job_descriptions_company_created_at", table_name="job_descriptions"
    )
